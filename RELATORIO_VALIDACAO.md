...
- Solar: geração noturna igual a zero
- Emissões: fator sintético documentado e cálculo validado
- Avisos: tarifas e fator de emissão são premissas sintéticas para demonstração
